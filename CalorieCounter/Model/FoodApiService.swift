...
class FoodApiService {
    ...
    func getFoodsData2(foodsUrl: String,completion: @escaping (Result<FoodsData, Error>) -> Void) {
    ...
    func getImageDataFrom(url: String, completion: @escaping (Result<Data, Error>) -> Void) {
